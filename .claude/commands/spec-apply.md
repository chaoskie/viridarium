...
5. **Gate-check (`QG-004`):** post PASS/FAIL (tests green, boundaries clean `ARCH-003`, dual-engine portable `ARCH-011`, scope unchanged `SPEC-001`) before the next task group. Circuit breaker applies (`QG-007`).
